      ...
      <div className="small-container">
        ...
        <div className="model-main-grid" key={index}>
          ...
          {/* <div className="model-grid-2">
            <div className="under-flex-112">
              <h3>Battery</h3>
              <h2 style={{ marginLeft: '22px' }}>-</h2>
            </div>
            <span className="line-114"></span>

            <div className="under-flex-112">
              <h3>Range</h3>
              <h2 style={{ marginLeft: '22px' }}>120-150 km</h2>
            </div>
            <span className="line-114"></span>

            <div className="under-flex-112">
              <h3>GVW</h3>
              <h2 style={{ marginLeft: '20px' }}>28 tons</h2>
            </div>
            <span className="line-114"></span>
            ...
            <div className="under-flex-112">
              <h3>Charging</h3>
              <h2 style={{ marginLeft: '20px' }}> 2 hrs (fast)</h2>
            </div>
            <span className="line-114"></span>

            <div className="under-flex-112">
              <h3>Power</h3>
              <h2 style={{ marginLeft: '20px' }}>362 bhp</h2>
            </div>
            <span className="line-114"></span>
          ...
          {/* <div className="model-grid-1">
            <h3 className="conts">BYD Q1R</h3>
            <img src="/imagesclient-img-2.png" className="byd-img" />
          </div>


          <div className="model-grid-1">
            <h3 className="conts">Olectra Meghaetron</h3>
            <img src="/imagesclient-img-3.jpg" className="byd-img" />
          </div>
          ...
          <div className="model-grid-2">
            ...
            <div className="under-flex-112">
              <h3>Range</h3>
              <h2 style={{ marginLeft: '22px' }}>300-350 km</h2>
            </div>
            <span className="line-114"></span>

            <div className="under-flex-112">
              <h3>GVW</h3>
              <h2 style={{ marginLeft: '20px' }}>11.9 tons</h2>
            </div>
            <span className="line-114"></span>

            <div className="under-flex-112">
              <h3>Payload</h3>
              <h2 style={{ marginLeft: '20px' }}>5 tons</h2>
            </div>
            <span className="line-114"></span>
          ...
          <div className="model-grid-1">
            <h3 className="conts">Ashok Leyland Boss 1218 HB EV</h3>
            <img src="/imagesclient-img-4.png" className="byd-img" />
          </div> */}
